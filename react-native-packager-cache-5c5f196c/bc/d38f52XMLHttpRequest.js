...
var _XMLHttpRequestEventTarget=require('./XMLHttpRequestEventTarget.js');var _XMLHttpRequestEventTarget2=babelHelpers.interopRequireDefault(_XMLHttpRequestEventTarget);
var _log=require('../utils/log.js');var _log2=babelHelpers.interopRequireDefault(_log);
var _Blob=require('./Blob.js');var _Blob2=babelHelpers.interopRequireDefault(_Blob);
...
XMLHttpRequest=function(_XMLHttpRequestEventT){babelHelpers.inherits(XMLHttpRequest,_XMLHttpRequestEventT);babelHelpers.createClass(XMLHttpRequest,[{key:'UNSENT',get:function get()
...
_method=this._method,_url=this._url,_headers=this._headers;
