...
Blob=function(_EventTarget){babelHelpers.inherits(Blob,_EventTarget);babelHelpers.createClass(Blob,[{key:'blobPath',get:function get()
...
function Blob(data,cType,defer){babelHelpers.classCallCheck(this,Blob);var _this=babelHelpers.possibleConstructorReturn(this,(Blob.__proto__||Object.getPrototypeOf(Blob)).call(this));_this.isRNFetchBlobPolyfill=true;_this.multipartBoundary=null;_this._ref=null;_this._blobCreated=false;_this._onCreated=[];_this._closed=false;
...
var orgPath=_this._ref;
if(defer)
return babelHelpers.possibleConstructorReturn(_this);else
{
p=_fs2.default.stat(orgPath).
then(function(stat){
...
}babelHelpers.createClass(Blob,[{key:'onCreated',value:function onCreated(
...
start,end){var _this2=this;var contentType=arguments.length>2&&arguments[2]!==undefined?arguments[2]:'';
if(this._closed)
...
_fs2.default.exists(blobCacheDir).
then(function(exist){
if(exist)
return Promise.resolve();
return _fs2.default.mkdir(blobCacheDir);
}).
then(function(){return _fs2.default.slice(_this2._ref,resPath,start,end);}).
then(function(dest){
