...
var _StatefulPromise=require('./class/StatefulPromise.js');var _StatefulPromise2=babelHelpers.interopRequireDefault(_StatefulPromise);
...
var _polyfill=require('./polyfill');var _polyfill2=babelHelpers.interopRequireDefault(_polyfill);
var _lodash=require('lodash');var _lodash2=babelHelpers.interopRequireDefault(_lodash);
var _android=require('./android');var _android2=babelHelpers.interopRequireDefault(_android);
var _ios=require('./ios');var _ios2=babelHelpers.interopRequireDefault(_ios);
var _net=require('./net');var _net2=babelHelpers.interopRequireDefault(_net);
var _jsonStream=require('./json-stream');var _jsonStream2=babelHelpers.interopRequireDefault(_jsonStream);var

RNFetchBlobSession=_fs2.default.RNFetchBlobSession,
...
var respInfo={};var _ref=[].concat(babelHelpers.toConsumableArray(
args)),method=_ref[0],url=_ref[1],headers=_ref[2],body=_ref[3];



_lodash2.default.each(headers,function(h,i){
headers[i]=h||'';
});
...
function FetchBlobResponse(taskId,info,data){var _this=this;babelHelpers.classCallCheck(this,FetchBlobResponse);
this.data=data;
this.taskId=taskId;
