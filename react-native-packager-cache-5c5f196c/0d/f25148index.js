Object.defineProperty(exports,"__esModule",{value:true});exports.ImageOptions=exports.upcomingEvent=exports.FakeNotifications=exports.FakeConversations=exports.currentUser=exports.FakeMessages=exports.FakeUsers=exports.Technologies=exports.ReactLogo=exports.DefaultAvatar=exports.Headers=exports.BackgroundImage=exports.SolidColors=undefined;var _underscore=require('underscore');

var SolidColors=exports.SolidColors=[
'red',
'deepPurple',
'indigo',
'teal',
...
var BackgroundImage=exports.BackgroundImage='https://s3-us-west-2.amazonaws.com/assembliesapp/welcome%402x.png';

var Headers=exports.Headers={
'Content-Type':'application/json'};


var DefaultAvatar=exports.DefaultAvatar='https://confluence.slac.stanford.edu/s/en_GB/5996/4a6343ec7ed8542179d6c78fa7f87c01f81da016.20/_/images/icons/profilepics/default.png';
var ReactLogo=exports.ReactLogo='https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/React.js_logo.svg/2000px-React.js_logo.svg.png';
...
var FakeUsers=exports.FakeUsers=[
...
var FakeMessages=exports.FakeMessages=[
'Hello world',
'How are you?',
'Yo',
...
var d2=new Date(d1-Math.floor(Math.random()*30)*24*60*60*1000);
return d2.valueOf();
};

function randomEventDate(){
var d1=new Date().valueOf();
var d2=new Date(d1+Math.floor(Math.random()*30)*24*3600*1000);
return d2.valueOf();
}
...
var FakeConversations=exports.FakeConversations=FakeUsers.map(function(user,idx){return{
...
var FakeNotifications=exports.FakeNotifications=[
...
var upcomingEvent=exports.upcomingEvent={
...
var ImageOptions=exports.ImageOptions={
title:'Select Avatar',
